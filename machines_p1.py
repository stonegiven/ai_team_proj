...
WEIGHT_CHANGE = 0.03 # 뒤로갈 수록 가중치를 줄여 집중탐색할거임
...
CALC_TIME = [1, 1, 3, 5, 10, 12, 15, 18, 20, 22, 25, 27, 29, 32, 35, 37, 45, 35, 32, 29, 27, 25, 22, 20, 18, 15, 12, 10, 8, 6, 3, 1]
...
# p1 *** player에 따라 다름! ***
class P1():
    head = place_Node(None, new_board() , None, new_pieces(), False) # root_node
